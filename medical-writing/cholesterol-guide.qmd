...
::: {.custom-figure}
![Healthy artery: HDL in blue, LDL in yellow.](cholesterol-images/healthy_artery.png){#fig-bloqueada width="47%"}
:::

::: {.custom-figure}
![Atherosclerosis.](cholesterol-images/atherosclerosis.png){#fig-bloqueada width="47%"}
:::
